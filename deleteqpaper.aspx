<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="deleteqpaper.aspx.cs" Inherits="OnlineExamSystem.deleteqpaper" %>
            ...
            <table class="auto-style1" align="center">
                ...
                <tr>
                    <td style ="text-align:center">
                        <asp:DropDownList ID="DropDownList1" runat="server" DataSourceID="SqlDataSource1" DataTextField="settype" DataValueField="settype" Height="22px" Width="200px" AutoPostBack="True">
                            
                        </asp:DropDownList>
                        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" SelectCommand="SELECT DISTINCT [settype] FROM [question] ORDER BY [settype]">
                        </asp:SqlDataSource></td>
                                         
                </tr>
                 
                 <tr>
                    <td style ="text-align:center" class="auto-style2"><asp:Button ID="dtest" runat="server" Text="Delete Test" Width="200px" style="font-weight:700" OnClick="dtest_Click"/>
                        &nbsp;</td>
